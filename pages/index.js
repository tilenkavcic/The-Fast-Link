...
const Home = () => {
	...
	return (
		<>
			<Layout title="The Fast Link" description="The Fast Link - easily make beautiful and fast podcast links, see your listenership grow">
				...
				<Container>
					<Row>
						<Col>
							<h1 className={styles.heroTitle}>Optimized to convert</h1>
						</Col>
					</Row>
					<Row>
